        ...
        <div className="App">
            ...
            <div>
                <ThemeProvider theme={theme === 'light' ? lightTheme : darkTheme}>
                    <GlobalStyle />
                    <StyledApp>
                        <h1>Demo of change the theme</h1>

                        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" onClick={() => themeToggler()}>Change theme color</button>
                    </StyledApp>
                </ThemeProvider>
            </div>
        </div>
